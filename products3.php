	   ...
	   <div class="products-page">
			<div class="products">
				...
				<div class="latest-bis">
					<img src="imag/D10.jpg" class="img-responsive" alt="" />
					<div class="offer">
						<p>40%</p>
							...
							<a class="cbp-vm-image" href="#">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
									<img src="imag/D1.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Lee Cooper Blue</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
							  ...
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/D2.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Wrangler Blue Millard</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/D3.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Counter Culture Black</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.3000</span></div>
									   <div class="clearfix"></div>
								     </div>		
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/D4.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Urbano Fashion Blue</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.4000</span></div>
									   <div class="clearfix"></div>
								     </div>		
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/D5.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">X-CROSS Grey</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/D6.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Wajbee Black </p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.4000</span></div>
									   <div class="clearfix"></div>
								     </div>		
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/D7.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Spykar Blue Skinny Fit</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.3000</span></div>
									   <div class="clearfix"></div>
								     </div>		
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/D8.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Highlander Black</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/D9.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Lee Navy Raw </p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.3000</span></div>
									   <div class="clearfix"></div>
								     </div>		
