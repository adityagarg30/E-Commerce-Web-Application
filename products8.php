			...
			<div class="products">
				<div class="product-listy">
					...
					<ul class="product-list">
                        ...
                        <li><a href="">Baggle</a></li>
                        <li><a href="">Ball Gown</a></li>
						
					</ul>
				</div>
				<div class="latest-bis">
					<img src="imag/I10.JPG" class="img-responsive" alt="" />
					<div class="offer">
						<p>40%</p>
							...
							<a class="cbp-vm-image" href="#">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
									<img src="imag/I1.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Haltung Light Blue </p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
							  ...
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/I2.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Lee Cooper Blue Slim</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/I3.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Vero Moda Denim Jeans</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/I4.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Ganga Black Denim Jeans </p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/I5.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">FlyJohn Blue Denim Jeans</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/I6.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Nifty Blue Denim Jeans</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/I7.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/I8.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Smart Lady White Denim</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.2500</span></div>
									   <div class="clearfix"></div>
								     </div>		
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/I9.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Nifty Denim Lycra Jeans</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.2000</span></div>
									   <div class="clearfix"></div>
								     </div>		
