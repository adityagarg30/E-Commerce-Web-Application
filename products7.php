			...
			<div class="products">
				<div class="product-listy">
					...
					<ul class="product-list">
						...
						<li><a href="">Top Wears</a></li>
                        <li><a href="#">Dresses</a></li>
                        <li><a href="">Winter Wears</a></li>
                        <li><a href="">Rain Wears</a></li>
						<li><a href="">Sport Wears</a></li>
                        <li><a href="">Bottom Wears</a></li>
                        <li><a href="">Toops</a></li>
						
					</ul>
				</div>
				<div class="latest-bis">
					<img src="imag/G10.JPG" class="img-responsive" alt="" />
					<div class="offer">
						<p>40%</p>
							...
							<a class="cbp-vm-image" href="#">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
									<img src="imag/G1.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Tokyo Polyester Dresses</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.5000</span></div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
			                     </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
							  ...
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/G2.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">At499 Black Net Dresses</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.3000</span></div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
			                     </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/G3.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Mini Shift Dresses</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.2000</span></div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
			                     </div>
							...
							<a class="cbp-vm-icon cbp-vm-add item_add" href="checkouts.php">Add to cart</a>
							</div>
						</li>
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/G4.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Elevate Net Dresses</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.2500</span></div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
			                     </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/G5.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Blue Polyester Dresses</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.3500</span></div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
			                     </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/G6.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Mayra Pink Poly Georgette</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.4000</span></div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
			                     </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/G7.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Texco Cotton Dress</p>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/G8.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Green Georgette Dress</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.2500</span></div>
									   <div class="clearfix"></div>
								     </div>		
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/G9.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Miss Chase Black Cotton </p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.2000</span></div>
									   <div class="clearfix"></div>
								     </div>		
