		...
		<div class="cart-gd">
			 ...
			 <div class="cart-header">
				 ...
				 <div class="cart-sec simpleCart_shelfItem">
					   ...
					   <div class="cart-item-info">
						<h3><a href="products1.php">Fanvi Black Canvas </a><span>Pickup time:</span></h3>
						<ul class="qty">
							<li><p>Min. order value:</p></li>
							<li><p>FREE delivery</p></li>
						</ul>
							 <div class="delivery">
							 <p>Service Charges : Rs.100</p>
			 ...
			 <div class="cart-header2">
				 <div class="close2"> </div>
				  <div class="cart-sec simpleCart_shelfItem">
					   ...
					   <div class="cart-item-info">
						<h3><a href="products4.php"> Fastrack ND3L01 Watch</a><span>Pickup time:</span></h3>
						<ul class="qty">
							<li><p>Min. order value:</p></li>
							<li><p>FREE delivery</p></li>
						</ul>
			 ...
			 <div class="cart-header">
				 ...
				 <div class="cart-sec simpleCart_shelfItem">
					   ...
					   <div class="cart-item-info">
						<h3><a href="products12.php">Lenovo Black Laptop Bags </a><span>Pickup time:</span></h3>
						<ul class="qty">
							<li><p>Min. order value:</p></li>
							<li><p>FREE delivery</p></li>
						</ul>
			  ...
			  <div class="cart-header3">
				 <div class="close3"> </div>
				  <div class="cart-sec simpleCart_shelfItem">
					   ...
					   <div class="cart-item-info">
						<h3><a href="products7.php">Mini Shift Dresses </a><span>Pickup time:</span></h3>
						<ul class="qty">
							<li><p>Min. order value:</p></li>
							<li><p>FREE delivery</p></li>
						</ul>
