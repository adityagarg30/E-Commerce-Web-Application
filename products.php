	   ...
	   <div class="products-page">
			<div class="products">
				...
				<div class="latest-bis">
					<img src="imag/A10.JPG" class="img-responsive" alt="" />
					<div class="offer">
						<p>40%</p>
							...
							<a class="cbp-vm-image" href="#">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
									<img src="imag/A1.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Mufti Blue Blazer</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
							  ...
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/A3.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Jack & Jones Jeans</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/A5.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Maniac Grey Cotton Blend</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/A6.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">UCB Red Shirt</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/A9.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Puma Full Sleeve Hooded</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/A2.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">BLACKBERRYS Brown</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/A4.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Wrangler Blue Skinny Fit</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.3000</span></div>
									   <div class="clearfix"></div>
								     </div>		
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/A7.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Highlander Navy Slim Fit</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.2500</span></div>
									   <div class="clearfix"></div>
								     </div>		
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/A8.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">Leana White Cotton T-Shirt</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.2000</span></div>
									   <div class="clearfix"></div>
								     </div>		
