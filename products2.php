	   ...
	   <div class="products-page">
			<div class="products">
				...
				<div class="latest-bis">
					<img src="imag/C11.jpg" class="img-responsive" alt="" />
					<div class="offer">
						<p>40%</p>
							...
							<a class="cbp-vm-image" href="#">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
									<img src="imag/C1.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">US Polo</p>
									   </div>
						...
						<li>
							<a class="cbp-vm-image" href="#">
							  ...
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/C2.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/C3.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/C4.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/C5.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/C6.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title">John Player</p>
									   </div>
									   <div class="pricey"><span class="item_price">Rs.4000</span></div>
									   <div class="clearfix"></div>
								     </div>		
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/C7.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/C8.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="#">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="imag/c9.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
